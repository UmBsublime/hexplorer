...
class BannedChampion(BaseModel):
    pickTurn: int = Field(..., description="The turn during which the champion was banned")
...
class Observer(BaseModel):
    encryptionKey: str = Field(..., description="Key used to decrypt the spectator grid game data for playback")
...
class Participant(BaseModel):
    bot: bool = Field(..., description="Flag indicating whether or not this participant is a bot")
    spell2Id: int = Field(..., description="The ID of the second summoner spell used by this participant")
    profileIconId: int = Field(..., description="The ID of the profile icon used by this participant")
    summonerName: str = Field(..., description="The summoner name of this participant")
    championId: int = Field(..., description="The ID of the champion played by this participant")
    teamId: int = Field(
        ...,
        description="The team ID of this participant, indicating the participant's team",
    )
    spell1Id: int = Field(..., description="The ID of the first summoner spell used by this participant")
...
class CurrentGameParticipant(BaseModel):
    ...
    summonerName: str = Field(..., description="The summoner name of this participant")
    summonerId: str = Field(..., description="The encrypted summoner ID of this participant")
    spell1Id: int = Field(..., description="The ID of the first summoner spell used by this participant")
    spell2Id: int = Field(..., description="The ID of the second summoner spell used by this participant")
    gameCustomizationObjects: List[GameCustomizationObject] = Field(..., description="List of Game Customizations")
...
class FeaturedGameInfo(BaseModel):
    ...
    bannedChampions: List[BannedChampion] = Field(..., description="Banned champion information")
    ...
    gameStartTime: int = Field(..., description="The game start time represented in epoch milliseconds")
    participants: List[Participant] = Field(..., description="The participant information")
    platformId: str = Field(..., description="The ID of the platform on which the game is being played")
...
class CurrentGameInfo(BaseModel):
    ...
    observers: Observer = Field(..., description="The observer information")
    participants: List[CurrentGameParticipant] = Field(..., description="The participant information")


class FeaturedGames(BaseModel):
    gameList: List[FeaturedGameInfo] = Field(..., description="The list of featured games")
    clientRefreshInterval: int = Field(
        ...,
